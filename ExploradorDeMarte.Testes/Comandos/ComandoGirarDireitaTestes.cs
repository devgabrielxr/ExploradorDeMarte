...
public class ComandoGirarDireitaTestes
{
    [Fact(DisplayName = "Fábrica deve criar comando de girar à direita e executar corretamente")]
    public void Executar_DeveGirarSondaParaEsquerda()
    {
        ...
        IComandoSonda comando = FabricaDeComandoSonda.Criar('R');
